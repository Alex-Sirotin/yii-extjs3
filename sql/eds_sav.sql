...
CREATE DATABASE IF NOT EXISTS `eds_sav` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `eds_sav`;
...
CREATE TABLE IF NOT EXISTS `tbl_issue` (
  ...
  `support_id` int(11) DEFAULT NULL COMMENT 'FK Поддержка',
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='Сообщения по запросу';
...
CREATE TABLE IF NOT EXISTS `tbl_user` (
  ...
  `role_id` int(11) NOT NULL DEFAULT '1' COMMENT 'FK Роль',
  `full_name` varchar(1000) DEFAULT NULL COMMENT 'Имя пользователя',
  PRIMARY KEY (`user_id`),
...
INSERT INTO `tbl_user` (`user_id`, `login`, `is_active`, `password`, `role_id`, `full_name`) VALUES
	(1, 'Alex', 1, '48efc4851e15940af5d477d3c0ce99211a70a3be', 1, NULL),
	(2, 'Justas', 1, '48efc4851e15940af5d477d3c0ce99211a70a3be', 2, NULL),
	(3, 'ship', 1, '48efc4851e15940af5d477d3c0ce99211a70a3be', 3, NULL);
...
CREATE TABLE `v_issue` (
	...
	`client_id` INT(11) NOT NULL COMMENT 'FK Клиент',
	`support_id` INT(11) NULL DEFAULT NULL COMMENT 'FK Поддержка',
	`status_id` INT(11) NOT NULL DEFAULT '1' COMMENT 'FK Состояние запроса',
	...
	`is_closed` TINYINT(1) NOT NULL DEFAULT '0' COMMENT 'Открыт/закрыт',
	`close_date` TIMESTAMP NULL DEFAULT NULL COMMENT 'Дата закрытия',
	`client_login` VARCHAR(100) NULL DEFAULT NULL COMMENT 'Логин' COLLATE 'utf8_general_ci',
	`client_name` TEXT NULL DEFAULT NULL COLLATE 'utf8_general_ci',
	`support_login` VARCHAR(100) NULL DEFAULT NULL COMMENT 'Логин' COLLATE 'utf8_general_ci',
